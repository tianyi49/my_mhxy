...
6. 发版您的版本
    ...
    git tag v3.0.1-beta.1
    git push origin v3.0.1-beta.1
...
chore:升级棉絮MXU_VERSION: "v2.1.7"
chore:调整棉絮MXU_VERSION: "v2.1.7"
chore:升级maafw版本5.12.2.升级棉絮MXU_VERSION: v2.1.6
